...
# INPUT_SIZE = [1, 3, 640, 640]       # change if your model has different input size
# CHANNEL_MEAN_VALUE = [0, 0, 0]      # adjust if your preprocessing is different
# CHANNEL_STD_VALUE = [255, 255, 255] # adjust if needed
# QUANTIZE = False                     # True if you want INT8 quantization (requires dataset)
# DATASET_DIR = None                   # directory of images for quantization, if needed
